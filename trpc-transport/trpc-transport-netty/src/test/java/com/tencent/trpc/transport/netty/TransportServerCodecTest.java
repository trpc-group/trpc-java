...
public class TransportServerCodecTest extends ServerCodec {

    @Override
    public void encode(Channel channel, ChannelBuffer channelBuffer, Object message) {
        channelBuffer.writeBytes(((TestResponse) message).getBody().getBytes());
    }
    ...
    public Object decode(Channel channel, ChannelBuffer channelBuffer) {
        ...
        return new TestRequest(new String(bytes));
    }
