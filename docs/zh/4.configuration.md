...
| server               | close_timeout                | int       | 30000ms                                     | 否    | 关闭服务的超时时间（服务端全局)                                                              |
...
| plugins.worker_pool.name         | core_pool_size            | int     | 0              | 否    | 核心线程数                                                                      | 
| plugins.worker_pool.name         | maximum_pool_size         | int     | core_pool_size | 否    | 最大线程数量                                                                     | 
