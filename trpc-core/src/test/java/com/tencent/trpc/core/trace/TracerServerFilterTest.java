...
public class TracerServerFilterTest {
    ...
    @Before
    public void before() {
        TracerFactoryManager.getManager().registPlugin("tjg", TestTraceFactory.class);
    }
    ...
    @Test
    public void testSpanWithErrorFlag() {
        RpcServerContext context = new RpcServerContext();
        Request request = new DefRequest();
        request.setContext(context);
        RpcInvocation invocation = new RpcInvocation();
    ...
    public void testFinishSpanException() {
        TracerServerFilter exceptionFilter = new TracerServerFilter() {
            ...
            @Override
            public void finish(Span span, Request request, Response response, Throwable t) {
                throw new RuntimeException("finish exception");
            }
    ...
    @Test
    public void testWhenCompleteWithThrowable() {
        RpcServerContext context = new RpcServerContext();
        RpcContextUtils.putValueMapValue(context, RpcContextValueKeys.CTX_TRACER, NoopTracerFactory.create());
        Request request = new DefRequest();
        request.setContext(context);
    ...
    @Test
    public void testInjectWithErrorFlag() {
        RpcServerContext context = new RpcServerContext();
        Request request = new DefRequest();
        request.setContext(context);
        RpcInvocation invocation = new RpcInvocation();
